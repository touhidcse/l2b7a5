...
export default function ReviewSubmissionPage() {
    ...
    const onSubmit = async (data: ReviewFormData) => {
        ...
        try {  
            const res = await fetch(`${process.env.NEXT_PUBLIC_BACKEND_API_URL}/api/reviews/${defaultBookingId}`, {
                method: "POST",
            ...
            if (!res.ok) throw new Error(responseData.message || "Failed to submit review.");
